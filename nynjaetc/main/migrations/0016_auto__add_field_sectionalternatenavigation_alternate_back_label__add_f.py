...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionAlternateNavigation.alternate_back_label'
        db.add_column('main_sectionalternatenavigation', 'alternate_back_label',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SectionAlternateNavigation.alternate_next_label'
        db.add_column('main_sectionalternatenavigation', 'alternate_next_label',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SectionAlternateNavigation.alternate_back_label'
        db.delete_column('main_sectionalternatenavigation', 'alternate_back_label')

        # Deleting field 'SectionAlternateNavigation.alternate_next_label'
        db.delete_column('main_sectionalternatenavigation', 'alternate_next_label')
    ...
    models = {
        ...
        'main.sectionalternatenavigation': {
            ...
            'alternate_back': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'alternate_back_label': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'alternate_next': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'alternate_next_label': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
