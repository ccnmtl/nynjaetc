...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SectionQuizAnsweredCorrectly'
        db.create_table('main_sectionquizansweredcorrectly', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagetree.Section'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('main', ['SectionQuizAnsweredCorrectly'])


    def backwards(self, orm):
        # Deleting model 'SectionQuizAnsweredCorrectly'
        db.delete_table('main_sectionquizansweredcorrectly')
