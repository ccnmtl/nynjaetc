...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.encrypted_email'
        db.add_column('main_userprofile', 'encrypted_email',
                      self.gf('django_fields.fields.EncryptedEmailField')(default='', max_length=101, cipher='AES', blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.hrsa_id'
        db.add_column('main_userprofile', 'hrsa_id',
                      self.gf('django_fields.fields.EncryptedEmailField')(default='', max_length=101, cipher='AES', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.encrypted_email'
        db.delete_column('main_userprofile', 'encrypted_email')

        # Deleting field 'UserProfile.hrsa_id'
        db.delete_column('main_userprofile', 'hrsa_id')
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'encrypted_email': ('django_fields.fields.EncryptedEmailField', [], {'default': "''", 'max_length': '101', 'cipher': "'AES'", 'blank': 'True'}),
            'hrsa_id': ('django_fields.fields.EncryptedEmailField', [], {'default': "''", 'max_length': '101', 'cipher': "'AES'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
