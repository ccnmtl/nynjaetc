...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SectionTimestamp.timestamp'
        db.alter_column('main_sectiontimestamp', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'SectionTimestamp.timestamp'
        db.alter_column('main_sectiontimestamp', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
