...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionTimestamp.timestamp'
        db.add_column('main_sectiontimestamp', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date.today(), blank=True),
                      keep_default=False)

        # Adding field 'SectionTimestamp.user'
        db.add_column('main_sectiontimestamp', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SectionTimestamp.timestamp'
        db.delete_column('main_sectiontimestamp', 'timestamp')

        # Deleting field 'SectionTimestamp.user'
        db.delete_column('main_sectiontimestamp', 'user_id')
