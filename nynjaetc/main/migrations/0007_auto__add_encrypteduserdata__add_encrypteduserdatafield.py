...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EncryptedUserData'
        db.create_table('main_encrypteduserdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('which_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.EncryptedUserDataField'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('value', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('main', ['EncryptedUserData'])

        # Adding model 'EncryptedUserDataField'
        db.create_table('main_encrypteduserdatafield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('main', ['EncryptedUserDataField'])


    def backwards(self, orm):
        # Deleting model 'EncryptedUserData'
        db.delete_table('main_encrypteduserdata')

        # Deleting model 'EncryptedUserDataField'
        db.delete_table('main_encrypteduserdatafield')
