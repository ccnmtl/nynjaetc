...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TreatmentActivityBlock'
        db.create_table('treatment_activity_treatmentactivityblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('treatment_activity', ['TreatmentActivityBlock'])


    def backwards(self, orm):
        # Deleting model 'TreatmentActivityBlock'
        db.delete_table('treatment_activity_treatmentactivityblock')
